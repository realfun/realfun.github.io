...
(If you find the bookmarklet title to be too long on the bookmark bar/list, just rename it after adding them)
  ...
  * <a class="flat-btn" href="javascript:(()=>{const e='\__gptThreadWide__',t=document.getElementById(e);if(t){t.remove();return}const n=document.createElement('style');n.id=e;n.textContent=`
[class*='group'], [class*='thread'] {--thread-content-max-width: 80em !important;} .tableContainer.horzScrollShadows {margin: 0 !important;}`;document.head.appendChild(n)})();">ChatGPT Wide</a>: make ChatGPT conversation content wider when you have a bigger screen.
